...
class _CadastroJovemState extends State<CadastroJovem> {
  ...
  void _carregarjovens(String status) async {
    ...
    } else if (auth.tipoUsuario == "escola" || auth.tipoUsuario == "professor_externo") {
      jovens = await _jovemService.buscarJovensDaEscola(status);
              ...
              content: SingleChildScrollView( // Garante que o conteúdo não estoure em telas menores
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField<String>(
                      initialValue: moduloSelecionado,
                      decoration: InputDecoration(
                    ...
                    DropdownButtonFormField<String>(
                      initialValue: empresaSelecionada,
                      decoration: InputDecoration(
